 ...
 *
 *      CDN系统能够实时地根据网络流量和各节点的连接、负载状况以及到用户的距离和响应时间
 *      等综合信息将用户的请求重新导向离用户最近的服务节点上
 *
 ...
 *      减少远程访问的带宽、分担网络流量、减轻原站点WEB服务器等功能。
 *
 ...
 *
 *      使用CDN访问
 *          用户发起请求-->智能DNS解析(根据IP判断地理位置、接入网类型、选择路由最短和
 *          负载最轻的服务器)-->取得缓存服务器IP-->把内容返回给用户(如果缓存中有)-->
 *          向源站发起请求-->将结果返回给用户-->将结果存入缓存服务器
 *
 * CDN使用场景
 *      场景
